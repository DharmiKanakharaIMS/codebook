          ...
          <section>
            ...
            <div className="flex flex-wrap justify-around">
              ...
              <div className="max-w-xl my-3">
                ...
                <p className="my-3">
                  { inCart ?
                  <button onClick={()=>removefromcart(product)} className={`inline-flex items-center py-2 px-5 text-lg font-medium text-center text-white bg-red-600 rounded-lg hover:bg-red-800`}  disabled={!product.in_stock}>Remove Item <i className="ml-1 bi bi-trash3"></i></button>

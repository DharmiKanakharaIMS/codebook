 ...
 const email = useRef(null);
  ...
  const handleLogin = async(e) =>
  {
   ...
   const handleLoginGuest = async () => {
    email.current.value = import.meta.env.VITE_GUEST_LOGIN;
    ...
    try {
      ...
      res.accessToken ? navigate("/products") : toast.error(res);
    } catch (error) {
      toast.error(error.message, { position: "top-center" });
    }
  };
      ...
      <section>
        ...
        <form onSubmit={handleLogin}>
          ...
          <div className="mb-6">
              ...
              <input ref={password} type="password" autoComplete="current-password" id="password" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required />
          </div>

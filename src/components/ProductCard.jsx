...
function ProductCard({product}) {
    const {id,name,image_local,price,overview,best_seller,rating,in_stock} = product
        ...
        <div className="p-5">
            ...
            <p className="flex justify-between items-center">
                ...
                </span>
                {
                    ...
                    (
                        <button onClick={()=>addtocart(product)} className={`inline-flex items-center py-2 px-3 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 ${in_stock?"":"cursor-not-allowed"}`} disabled={!in_stock}>Add To Cart <i className="ml-1 bi bi-plus-lg"></i></button>
                    )
                }
